...
//    TODO add different language query
    ...
    @GET("search/movie")
    Call<DataResponse> searchMovie(@Query("api_key") String apiKey, @Query("query") String keyWord);

    @GET("search/tv")
    Call<DataResponse> searchTv(@Query("api_key") String apiKey, @Query("query") String keyWord);
}
